...
+ (instancetype)footerWithRefreshHandler:(RefreshedHandler)refreshHandler {
    ...
    footer.refreshHander = refreshHandler;
    return footer;
}
...
- (void)addRefreshContentView {
    ...
    _footerCircle = [[TLFFooterCircleView alloc] initWithFrame:CGRectMake(screenWidth/2.0 - 100, (LoadingOffsetHeight - 40)/2.0 + 5, 30, 30)];
    ...
    if (_refreshState != refreshState) {
        ...
        switch (refreshState) {
            ...
            case RefreshStateLoading:
            {
                ...
                if (self.refreshHander) {
                    self.refreshHander(self);
                }
